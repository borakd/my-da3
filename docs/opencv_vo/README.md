...
- [Primer: what the five metrics measure, and what the backbone actually computes](#primer-what-the-five-metrics-measure-and-what-the-backbone-actually-computes)
