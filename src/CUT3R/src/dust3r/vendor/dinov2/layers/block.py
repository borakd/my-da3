...
# Vendored for CUT3R: xformers is hard-disabled so this copy runs identically on
# plain torch everywhere. The nested-tensor (list-input) forward path, which is
# the only consumer of fmha/scaled_index_add/index_select_cat, raises exactly as
# upstream does when xformers is absent; the plain-Tensor path never needs it.
