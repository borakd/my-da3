...
unset PREV_PRED_RAY_SHUFFLE GT_RAY_MAP_SHUFFLE \
      ...
      STATE_GATE_MODE STATE_GATE_SIGNAL STATE_GATE_SCOPE STATE_GATE_TAU \
      STATE_GATE_TEMP STATE_GATE_REL_ALPHA STATE_GATE_WARMUP STATE_GATE_MAX_SKIP \
      STATE_GATE_GMIN STATE_GATE_INVERT STATE_GATE_CAP_TAU STATE_GATE_EMA \
      STATE_GATE_TAU_FILE REVISIT SKIP_FRAMES_FILE REVERSE \
      ORACLE
